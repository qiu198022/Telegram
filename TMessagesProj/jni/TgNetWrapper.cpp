...
void setUserId(JNIEnv *env, jclass c, jint instanceNum, int64_t id,int64_t phone) {
    ConnectionsManager::getInstance(instanceNum).setUserId(id,phone);
}
...
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_setUserId", "(IJJ)V", (void *) setUserId},
